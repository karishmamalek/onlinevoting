...
if ( ! class_exists( 'Online_Voting_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Online Voting 1.0
	 */
	class Online_Voting_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'onlinevoting' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'onlinevoting' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'onlinevoting' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'onlinevoting' ),
						'full'    => esc_html__( 'Full text', 'onlinevoting' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-onlinevoting-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Online_Voting_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Online_Voting_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'onlinevoting' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
